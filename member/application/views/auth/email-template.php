                ...
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        ...
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            Halo <?= $nama ?>!<br>
                            Password baru: <strong><?= $new_password; ?></strong>
                          </td>
                        </tr>
                        <tr>
                          <td>
                              ...
                              <tr>
                                <td style="width:200px;background:#008000;">
                                  <div><!--[if mso]>
                                    ...
                                    <![endif]-->
                                        <a href="<?= $url; ?>"
                                  style="background-color:#008000;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Login Sekarang</a>
                                    <!--[if mso]>
                                      </center>
                                    </v:rect>
                                  <![endif]--></div>
                  ...
                  <tr>
                    <td valign="top" class="footer-cell">
                      Lamlam<br>
                      Penyedia Web Builder, Hosting, dan Domain Terpercaya di Seluruh Indonesia
                    </td>
                  </tr>
                </table>
              </td>
